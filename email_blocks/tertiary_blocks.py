t1 = '''
    <tr><!--T1 TERTIARY - SINGLE CTA MIDDLE-->
...
'''
t3 = '''
	<tr><!--T3 TERTIARY - TRAINING COURSES-->
        <td bgcolor="#F4F7FE" class="outer" align="center" style="padding:0px;" >
            <!--[if (gte mso 9)|(IE)]>
            <table align="center" border="0" cellspacing="0" cellpadding="0" width="600">
            <tr>
						...
						<table bgcolor="#D9DBFF" border="0" cellpadding="0" cellspacing="0" width="100%" class="tertiary-cta inner-block">
							<tr>
								<td align="center" style="padding:20px;">
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 520px;">
										<tr>
											<td align="center" class="padding subheader" style="padding-bottom:20px;">Teams like you are using these courses</td>
										</tr>
										<!--PL TEMPLATES--->
										<tr>
											<td align="center"  valign="middle" width="100%">
																		...
																		<tr>
																			<td align="center" valign="middle" style="padding:5px;">
																				...
																				<table border="0" cellpadding="10" cellspacing="0" width="100%" bgcolor="#ffffff" class="pl-template">
																					<tr>
																						<td align="left" class="pl-template-label" style="padding:15px" valign="top">
																							<span style="font-size: 12px;color:#6559ff;">&#129504; COURSE</span><br>
																							{{training_course_1_title}}<br>
																							<span style="font-size: 12px;"><a href="https://app.safetyculture.com/training/manage/courseware?show=content-library&course-id={{training_course_1_id}}">Use this course</a></span>
																						</td>
																					</tr>
																				</table>
																				<!--[if (gte mso 9)|(IE)]>
																			...
																			<td align="" valign="middle" style="padding:5px;">
																				...
																				<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff" class="pl-template">
																					<tr>
																						<td align="left" class="pl-template-label" style="padding:15px" valign="top">
																							<span style="font-size: 12px;color:#6559ff;">&#129504; COURSE</span><br>
																							{{training_course_2_title}}<br>
																							<span style="font-size: 12px;"><a href="https://app.safetyculture.com/training/manage/courseware?show=content-library&course-id={{training_course_2_id}}">Use this course</a></span>
																						</td>
																					</tr>
																				</table>
																				<!--[if (gte mso 9)|(IE)]>
